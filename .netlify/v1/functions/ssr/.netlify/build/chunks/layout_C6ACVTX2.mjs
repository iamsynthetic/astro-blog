import { c as createComponent, m as maybeRenderHead, r as renderComponent, a as renderTemplate, d as addAttribute, b as createAstro, e as renderSlot, f as renderHead } from './astro/server_yeqXpKvY.mjs';
import 'kleur/colors';
/* empty css                         */
import '@astrojs/internal-helpers/path';
import '@astrojs/internal-helpers/remote';
import { $ as $$Image } from './_astro_assets_8yWp45sk.mjs';
import 'clsx';
import { g as getCollection } from './_astro_content_DvnmZPCb.mjs';
...
const logo = new Proxy({"src":"/_astro/logo.Bp-tjQcT.png","width":200,"height":200,"format":"png"}, {
						get(target, name, receiver) {
							...
							if (name === 'fsPath') {
								return "/Users/tomo/Documents/01_code/frameworks/astro/astro-blog/src/images/logo.png";
							}
...
TechPeople is a blog for tech enthusiasts. We publish articles, stories and tutorials about the latest technology trends
                    and advancements.
</p> </div> <div class="mt-10"> <h3 class="text-xl font-semibold mb-4">Categories</h3> <ul class="text-white text-sm"> ${uniqueTags.map((tag) => renderTemplate`<li class="mb-2"> <a${addAttribute("/articles/tag/" + tag, "href")}>#${capitalize(tag)}</a> </li>`)} </ul> </div> <div class="mt-10"> <h3 class="text-xl font-semibold mb-4">Contact</h3> <ul class="text-white text-sm"> <li class="mb-2"> <a href="www.hotmail.com">Email</a> </li> <li class="mb-2"> <a href="www.twitter.com">Twitter</a> </li> <li class="mb-2"> <a href="www.facebook.com">Facebook</a> </li> <li class="mb-2"> <a href="www.instagram.com">Instagram</a> </li> </ul> </div> </div> </div> </footer>`;
}, "/Users/tomo/Documents/01_code/frameworks/astro/astro-blog/src/components/Footer.astro", void 0);

const SITE_TITLE = "TechPeople Blog";
const SITE_DESCRIPTION = "Artilces, stories and tutorials from techpeople";
...
}, "/Users/tomo/Documents/01_code/frameworks/astro/astro-blog/src/layouts/layout.astro", void 0);

export { $$Layout as $, ARTICLES_PER_PAGE as A, HOMEPAGE_ARTICLE_LIMIT as H, capitalize as c, formatDate as f };
